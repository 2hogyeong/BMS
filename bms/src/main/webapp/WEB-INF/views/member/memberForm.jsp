...
<body>
	...
	<table class="table table-bordered table-hover">
        ...
        <tr>
	        ...
	        <td>
	        	<input class="form-control" id="memberPw" name="memberPw" type="password" placeholder="비밀번호를 입력하세요." onblur="passwordLength()" />
	        </td>
        </tr>
        <tr>
	        <td>
	        ...
	        <td>
	        	<input class="form-control" type="password" id="password" placeholder="비밀번호를 입력하세요." onblur="checkPassword()"/>
	        	<p id="check"></p>
	        </td>
        </tr>         
        <tr>
