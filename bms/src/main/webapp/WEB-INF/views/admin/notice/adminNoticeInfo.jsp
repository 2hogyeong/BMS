...
<body>
	...
	<table class="table table-bordered table-hover">
     ...
     <p align="right">
	     ...
	     <input type="button" class="btn btn-indigo btn-sm" value="수정하기" onclick="location.href='${contextPath }/admin/notice/adminNoticeUpdate.do?num=${ndto.num }'">
	     <input type="button" class="btn btn-indigo btn-sm" value="삭제하기" onclick="location.href='${contextPath }/admin/notice/adminNoticeDelete.do?num=${ndto.num }'">
     </p>
     </form>
