...
<body>
			 	...
			 	<c:otherwise>
     				<c:forEach var="item" items="${NoticeList}">
						<tr align="center">       
							...
							<td>
								<a href="${contextPath}/admin/notice/adminNoticeInfo.do?num=${item.num}">
	...
	<br>
	<div align="right">
		<input class="btn btn-indigo btn-sm" type="button" onclick="location.href='${contextPath}/admin/notice/adminNoticeWrite.do'" value="글쓰기">
	</div>
