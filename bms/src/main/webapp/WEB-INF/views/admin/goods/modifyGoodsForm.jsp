						...
						<tr>
							...
							<td>
								<select name="goodsSort" class="form-control" style="height:30; padding:0">
									...
									<option value="수험서 자격증" <c:if test="${goods.goodsSort=='수험서 자격증' }">selected </c:if>>수험서/자격증</option>
									<option value="외국어" <c:if test="${goods.goodsSort=='외국어' }">selected </c:if>>외국어</option>
									<option value="취업 진로" <c:if test="${goods.goodsSort=='취업 진로' }">selected </c:if>>취업/진로</option>
									<option value="에세이" <c:if test="${goods.goodsSort=='에세이' }">selected </c:if>>에세이</option>
									<option value="소설 시 희곡" <c:if test="${goods.goodsSort=='소설 시 희곡' }">selected </c:if>>소설/시/희곡</option>
								</select>
							</td>
						...
						<tr>
							...
							<td>
								<select name="goodsStatus" class="form-control" style="height:30; padding:0">
									<option value="bestseller" <c:if test="${goods.goodsStatus } eq 'bestseller'"> selected</c:if> >베스트셀러</option>
									...
									<option value="etc" <c:if test="${goods.goodsStatus } eq 'etc'"> selected</c:if>>기타</option>
								</select> 
