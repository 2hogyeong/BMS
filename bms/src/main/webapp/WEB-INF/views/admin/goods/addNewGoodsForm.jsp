					...
					<tr>
						...
						<td width=500>
							<select name="goodsSort" class="form-control" style="padding-bottom:0; padding-top:0; height:35px">
								<option value="computer" selected>컴퓨터와 인터넷
								<option value="digital">디지털 기기
								<option value="examination">수험서/자격증
								<option value="foreign">외국어
								<option value="career">취업/진로
								<option value="essay">에세이
								<option value="fiction">소설/시/희곡
							</select>
						</td>
					</tr>
					<tr>
